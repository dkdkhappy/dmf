...
WITH WT_WHERE AS
    ...
    (
      SELECT A.STATISTICS_DATE
            ,A.SALE_AMT_RMB - COALESCE(B.REFD_AMT_RMB, 0) AS SALE_AMT_RMB
    ...
    (
      SELECT A.STATISTICS_DATE
            ,A.SALE_AMT_KRW - COALESCE(B.REFD_AMT_KRW, 0) AS SALE_AMT_KRW
    ...
    (
      SELECT A.STATISTICS_DATE
            ,A.SALE_AMT_RMB - COALESCE(B.REFD_AMT_RMB, 0) AS SALE_AMT_RMB
        FROM WT_SALE_AMT_RMB_YOY A
        LEFT JOIN WT_REFD_AMT_RMB_YOY B
        ON A.STATISTICS_DATE = B.STATISTICS_DATE
        WHERE A.STATISTICS_DATE BETWEEN (SELECT FR_DT_YOY FROM WT_WHERE) AND (SELECT TO_DT_YOY FROM WT_WHERE)
    ), WT_AMT_KRW_YOY AS
    (
      SELECT A.STATISTICS_DATE
            ,A.SALE_AMT_KRW - COALESCE(B.REFD_AMT_KRW, 0) AS SALE_AMT_KRW
        FROM WT_SALE_AMT_KRW_YOY A
        LEFT JOIN WT_REFD_AMT_KRW_YOY B
        ON A.STATISTICS_DATE = B.STATISTICS_DATE
        WHERE A.STATISTICS_DATE BETWEEN (SELECT FR_DT_YOY FROM WT_WHERE) AND (SELECT TO_DT_YOY FROM WT_WHERE)
    ), WT_SUM AS
    (
    ...
    (
         SELECT A.SORT_KEY
               ...
               ,CASE
                  ...
                  WHEN A.SORT_KEY = 4
                  THEN (LAG(SALE_AMT_01_RMB, 3) OVER(ORDER BY A.SORT_KEY) - COALESCE(LAG(SALE_AMT_12_RMB, 2) OVER(ORDER BY A.SORT_KEY))) / LAG(SALE_AMT_12_RMB, 2) OVER(ORDER BY A.SORT_KEY) * 100
               ...
               ,CASE
                  ...
                  WHEN A.SORT_KEY = 4
                  THEN (LAG(SALE_AMT_01_KRW, 3) OVER(ORDER BY A.SORT_KEY) - COALESCE(LAG(SALE_AMT_12_KRW, 2) OVER(ORDER BY A.SORT_KEY))) / LAG(SALE_AMT_12_KRW, 2) OVER(ORDER BY A.SORT_KEY) * 100
    ...
    SELECT ROW_TITL
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_01_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_01_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_01_RMB   /* 01월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_02_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_02_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_02_RMB   /* 02월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_03_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_03_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_03_RMB   /* 03월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_04_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_04_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_04_RMB   /* 04월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_05_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_05_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_05_RMB   /* 05월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_06_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_06_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_06_RMB   /* 06월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_07_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_07_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_07_RMB   /* 07월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_08_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_08_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_08_RMB   /* 08월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_09_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_09_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_09_RMB   /* 09월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_10_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_10_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_10_RMB   /* 10월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_11_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_11_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_11_RMB   /* 11월 매출 - 위안화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_12_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_12_RMB AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_12_RMB   /* 12월 매출 - 위안화 */

          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_01_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_01_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_01_KRW  /* 01월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_02_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_02_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_02_KRW  /* 02월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_03_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_03_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_03_KRW  /* 03월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_04_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_04_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_04_KRW  /* 04월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_05_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_05_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_05_KRW  /* 05월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_06_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_06_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_06_KRW  /* 06월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_07_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_07_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_07_KRW  /* 07월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_08_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_08_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_08_KRW  /* 08월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_09_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_09_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_09_KRW  /* 09월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_10_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_10_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_10_KRW  /* 10월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_11_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_11_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_11_KRW  /* 11월 매출 - 원화 */
          ,CASE WHEN SORT_KEY IN (3, 4) THEN TO_CHAR(CAST(SALE_AMT_12_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999.99%') ELSE TO_CHAR(CAST(SALE_AMT_12_KRW AS DECIMAL(20,2)), 'FM999,999,999,999,999') END AS SALE_AMT_12_KRW  /* 12월 매출 - 원화 */
      FROM WT_BASE
  ORDER BY SORT_KEY