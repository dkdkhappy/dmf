...
WITH WT_WHERE AS
    ...
    SELECT A.SALE_RANK                                                         /* 순위                   */
          ...
          ,CAST(RMB_01.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_01_RMB /* 01월 제품금액 - 위안화 */
          ,CAST(RMB_02.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_02_RMB /* 02월 제품금액 - 위안화 */
          ,CAST(RMB_03.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_03_RMB /* 03월 제품금액 - 위안화 */
          ,CAST(RMB_04.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_04_RMB /* 04월 제품금액 - 위안화 */
          ,CAST(RMB_05.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_05_RMB /* 05월 제품금액 - 위안화 */
          ,CAST(RMB_06.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_06_RMB /* 06월 제품금액 - 위안화 */
          ,CAST(RMB_07.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_07_RMB /* 07월 제품금액 - 위안화 */
          ,CAST(RMB_08.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_08_RMB /* 08월 제품금액 - 위안화 */
          ,CAST(RMB_09.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_09_RMB /* 09월 제품금액 - 위안화 */
          ,CAST(RMB_10.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_10_RMB /* 10월 제품금액 - 위안화 */
          ,CAST(RMB_11.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_11_RMB /* 11월 제품금액 - 위안화 */
          ,CAST(RMB_12.SALE_AMT AS DECIMAL(20,0))           AS SALE_AMT_12_RMB /* 12월 제품금액 - 위안화 */
          ...
          ,CAST(KRW_01.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_01_KRW /* 01월 제품금액 - 원화   */
          ,CAST(KRW_02.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_02_KRW /* 02월 제품금액 - 원화   */
          ,CAST(KRW_03.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_03_KRW /* 03월 제품금액 - 원화   */
          ,CAST(KRW_04.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_04_KRW /* 04월 제품금액 - 원화   */
          ,CAST(KRW_05.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_05_KRW /* 05월 제품금액 - 원화   */
          ,CAST(KRW_06.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_06_KRW /* 06월 제품금액 - 원화   */
          ,CAST(KRW_07.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_07_KRW /* 07월 제품금액 - 원화   */
          ,CAST(KRW_08.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_08_KRW /* 08월 제품금액 - 원화   */
          ,CAST(KRW_09.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_09_KRW /* 09월 제품금액 - 원화   */
          ,CAST(KRW_10.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_10_KRW /* 10월 제품금액 - 원화   */
          ,CAST(KRW_11.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_11_KRW /* 11월 제품금액 - 원화   */
          ,CAST(KRW_12.SALE_AMT AS DECIMAL(20,0))          AS SALE_AMT_12_KRW /* 12월 제품금액 - 원화   */
