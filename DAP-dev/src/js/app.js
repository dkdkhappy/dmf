            ...
            : "it" == e
              ...
              : "ru" == e
                ...
                : "ch" == e
                  ...
                  : "ko" == e
                    ? (document.getElementById("header-lang-img").src = "/static/images/flags/kr.svg")
                    : "fr" == e
      ...
      e =
        (e < 1025 && 767 < e
          ? (document.body.classList.remove("twocolumn-panel"),
            "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), h(), A(), f()),
          ...
          : 1025 <= e
            ? (document.body.classList.remove("twocolumn-panel"),
              ...
              document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open"))
            : e <= 767 &&
            (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), f()), "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon"))
            && document.querySelector(".hamburger-icon").classList.remove("open"),
  ...
  function k(e) {
    "vertical" == e
      ? ((document.getElementById("two-column-menu").innerHTML = ""),
        ...
        ((document.getElementById("sidebar-size").style.display = "block"), (document.getElementById("sidebar-view").style.display = "block"), (document.getElementById("sidebar-color").style.display = "block"), document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = "block"), (document.getElementById("layout-position").style.display = "block"), (document.getElementById("layout-width").style.display = "block")),
        S(),
        L(),
        q(),
        x())
      ...
      switch (e["data-body-image"]) {
        ...
        default:
          sessionStorage.getItem("data-body-image") && "img-1" == sessionStorage.getItem("data-body-image")
            ? (sessionStorage.setItem("data-body-image", "img-1"), T("data-body-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && ((document.getElementById("sidebar-img").style.display = "none"), document.documentElement.removeAttribute("data-sidebar-image")))
  ...
  sessionStorage.getItem("defaultAttribute")
    ...
    Array.from(m).forEach(function (e) {
      ...
      if ("flatpickr" == e.getAttribute("data-provider")) {
        ...
        if (o["data-deafult-date"]) {
          t.defaultDate = o["data-deafult-date"].value.toString();
          t.dateFormat = o["data-date-format"].value.toString();
        }

        if (o["data-multiple-date"]) {
          t.mode = "multiple";
          t.dateFormat = o["data-date-format"].value.toString();
        }

        if (o["data-range-date"]) {
          t.mode = "range";
          t.dateFormat = o["data-date-format"].value.toString();
        }

        if (o["data-inline-date"]) {
          t.inline = true;
          t.defaultDate = o["data-deafult-date"].value.toString();
          t.dateFormat = o["data-date-format"].value.toString();
        }

        if (o["data-disable-date"]) {
          a = [];
          a.push(o["data-disable-date"].value);
          t.disable = a.toString().split(",");
        }

        if (o["data-week-number"]) {
          a = [];
          a.push(o["data-week-number"].value);
          t.weekNumbers = true;
        }

        if (o["data-month-picker"]) { // add this condition to check if it's monthpicker
          a = [];
          a.push(
            new monthSelectPlugin({
              shorthand: true,
              dateFormat: o["data-date-format"] ? o["data-date-format"].value : "Y-m",
              altFormat: "Y-m",
            })
          )
          t.plugins = a;
        ...
        if (o["data-max-time"]) {
          ...
          a.noCalendar = true;
          a.dateFormat = "H:i";
          a.maxTime = o["data-max-time"].value.toString();
        }
        if (o["data-default-time"]) {
          a.enableTime = true;
          a.noCalendar = true;
          a.dateFormat = "H:i";
          a.defaultDate = o["data-default-time"].value.toString();
        }
        if (o["data-time-inline"]) {
          a.enableTime = true;
          a.noCalendar = true;
