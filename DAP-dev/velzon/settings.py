...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'file_exists': 'templatetags.file_exists',
            }
        },
    },
]
...
# Old DB : dap-database.cuwldr2bamdp.ap-northeast-2.rds.amazonaws.com
# New DB : derma-dap-db.cuwldr2bamdp.ap-northeast-2.rds.amazonaws.com
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'HOST': 'derma-dap-db.cuwldr2bamdp.ap-northeast-2.rds.amazonaws.com',
        'PORT': 5432,
        'NAME': 'postgres',
        'USER': 'postgres',
        'PASSWORD': 'dapderma0220'
    },
    'dash': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'HOST': 'derma-dap-db.cuwldr2bamdp.ap-northeast-2.rds.amazonaws.com',
...
ACCOUNT_FORMS = {
    ...
    # "signup": "velzon.forms.CustomSignupForm",
...
# 배포 환경의 권한 문제로 인하여 /tmp 하위로 변경
DJANGO_DRF_FILEPOND_FILE_STORE_PATH = os.path.join('/tmp')
...
if sys.platform == 'win32':
    ...
    DJANGO_DRF_FILEPOND_UPLOAD_TMP = os.path.join(BASE_DIR, 'filefond_temp_uploads')
...
# sql storage
DJANGO_SQL_STORAGE = os.path.join(BASE_DIR, 'sql')
